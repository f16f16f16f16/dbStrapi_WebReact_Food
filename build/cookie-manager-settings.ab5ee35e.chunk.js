(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[148],{
...
const SettingsPage = () => {
  ...
  const getConfigData = () => __async(void 0, null, function* () {
    const config2 = yield cookie_manager/* default.getConfig */.Z.getConfig();
    setConfig(config2);
    setConfigIsLoading(false);
  });
  const updateConfig = (data) => __async(void 0, null, function* () {
    yield cookie_manager/* default.updateConfig */.Z.updateConfig(data);
  });
  ...
  (0,react.useEffect)(() => __async(void 0, null, function* () {
    yield getConfigData();
  }), []);
  return /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(dist.Formik, {
    ...
    handleChange,
    isSubmitting
  }) => /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(Layout.HeaderLayout, {
    title: formatMessage({
      id: (0,utils/* getTrad */.OB)("settings.header.title"),
      defaultMessage: utils/* pluginName */.oy
    }),
    subtitle: formatMessage({
      id: (0,utils/* getTrad */.OB)("settings.header.description"),
    ...
    shadow: "filterShadow",
    padding: 6
  }, configIsLoading ? /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(Stack.Stack, {
    spacing: 6,
    ...
    id: (0,utils/* getTrad */.OB)("settings.form.title"),
    defaultMessage: "Settings"
  })), /* @__PURE__ */ react.createElement(ToggleInput.ToggleInput, {
    hint: formatMessage({
      id: (0,utils/* getTrad */.OB)("settings.form.field.localization.hint"),
      defaultMessage: "Enable localization for this plugin"
    }),
    label: formatMessage({
      id: (0,utils/* getTrad */.OB)("settings.form.field.localization.label"),
      defaultMessage: "Internationalization"
    }),
    name: "localization",
    onLabel: formatMessage({
      id: (0,utils/* getTrad */.OB)("settings.form.field.localization.option.a"),
      defaultMessage: "True"
    }),
    offLabel: formatMessage({
      id: (0,utils/* getTrad */.OB)("settings.form.field.localization.option.b"),
